...
b_pressure.file = 'bml_barometric_pressure_2019-2020_hourly.csv';
series_length = '16653';
...
salinity.file = 'tbb_seawater_salinity_2019-2020_hourly.csv';
series_length = '16115';
...
%% TURBIDITY
% turbidity.file = 'tbb_seawater_turbidity_2019-2020_hourly.csv';
% series_length = '8434';
...
tbb_wind.spd_file = 'tbb_wind_speed_2019-2020_hourly.csv';
series_length = '16115';
tbb_wind.time = readmatrix([path_prefix tbb_wind.spd_file],'Range',['B1:B' series_length],'OutputType','datetime');
tbb_wind.spd = readmatrix([path_prefix tbb_wind.spd_file],'Range',['D1:D' series_length],'OutputType','double');
tbb_wind.spd_unit = 'mph';
tbb_wind.spd_interval = 'hourly';
tbb_wind.dir_file = ''; % no dice on this

%% WINDS FROM BML

bml_wind.spd_file = 'bml_wind_speed_2019-2020_hourly.csv';
series_length = '12056';
bml_wind.spd_time = readmatrix([path_prefix bml_wind.spd_file],'Range',['B1:B' series_length],'OutputType','datetime');
bml_wind.spd = readmatrix([path_prefix bml_wind.spd_file],'Range',['D1:D' series_length],'OutputType','double');
bml_wind.spd_unit = 'mph';
bml_wind.spd_interval = 'hourly';
bml_wind.dir_file = 'bml_wind_direction_2019-2020_hourly.csv';
series_length = '10034';
bml_wind.dir_time = readmatrix([path_prefix bml_wind.dir_file],'Range',['B1:B' series_length],'OutputType','datetime');
bml_wind.dir = readmatrix([path_prefix bml_wind.dir_file],'Range',['D1:D' series_length],'OutputType','double');
bml_wind.dir_unit = 'deg';
bml_wind.dir_interval = 'hourly';

%% WATER TEMPERATURE

temperature.file = 'tbb_seawater_temperature_2019-2020_hourly.csv';
series_length = '16115';
...
buoy_file = '46013_2019-2020_stdmet.txt';
...
% creates "WIND" and "SWELL" structs
% Swell Direction, Period, Height; Wind Direction, Wind Speed
% buoy_file = '46013_2019-2020_spectral.txt';
% fid = fopen([path_prefix buoy_file],'rt');
...
% Not doing tides or buoy spectra as of Nov 20 2020, just incorporating
% some 2020 data into the other categoriers. Also not doing turbidity. 

save conditions.mat b_pressure salinity temperature swell tbb_wind bml_wind
