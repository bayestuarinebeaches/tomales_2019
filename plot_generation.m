...
%     ylim([0 20]);
    ...
    switch wind_option
        ...
        case 5
            scatter(tbb_wind.time,tbb_wind.spd.*0.44704,'.');
            hold on
%             plot(hioc_wind.time,hioc_wind.spd.*0.44704,'-');
%             scatter(tboc_wind.time,tboc_wind.spd.*0.44704,'.');
%             legend('TBB','TBOC');
    end
...
switch wind_option
    ...
    case 5
        ...
        wind_speed_mapped = interp1(datenum(tbb_wind.time),tbb_wind.spd,datenum(window_times')).*0.44704;
%         wind_speed_mapped = interp1(datenum(tboc_wind.time),tboc_wind.spd,datenum(window_times')).*0.44704;
